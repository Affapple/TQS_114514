...
class CarServiceTest {
    ...
    @Test
    public void whenSaveCar_thenCarIsSaved() {
    ...
    @Test
    public void whenSearchExistingCar_thenFindCar() {
        assertThat(
    ...
    @Test
    public void whenSearchNonExistingCar_thenReturnNull() {
        assertThat(
            carService.getCarDetails(-1l).isPresent()
        ).isFalse();
    }

    @Test
    public void whenGetAllCars_thenGetAllCars() {
        assertThat(
    ...
    @Test
    public void whenSearchExistingReplacement_thenGetReplacement() {
